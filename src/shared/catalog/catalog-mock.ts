...
let mockCatalogs: CatalogRecord[] = [
  ...
  },
  {
    ...
    description: "库存数据 SQL Server 只读连接。",
    ...
    healthStatus: "healthy",
    healthCheckResult: "Connection test passed.",
    lastCheckTime: "2026-09-20 09:30:00",
    expectedUpdateTime: Date.parse("2026-09-20T01:30:00Z"),
    updateTime: "2026-09-20 09:30:00",
    createTime: "2026-09-19 14:20:00",
    updaterName: "Platform Admin",
    creatorName: "Platform Admin",
    tags: ["inventory", "sqlserver"],
    connectorConfig: {
    ...
    metadata: { schemas: ["dbo", "reporting"] },
    operations: [...MOCK_CATALOG_OPERATIONS],
    type: "physical",
  },
  {
    ...
    healthStatus: "healthy",
    healthCheckResult: "Connection test passed.",
    lastCheckTime: "2026-09-20 10:45:00",
    expectedUpdateTime: Date.parse("2026-09-20T02:45:00Z"),
    updateTime: "2026-09-20 10:45:00",
    createTime: "2026-09-19 15:10:00",
    updaterName: "Platform Admin",
    creatorName: "Platform Admin",
    tags: ["orders", "oracle"],
    connectorConfig: {
      ...
      options: { timeout: 30, charset: "UTF8" },
    },
    metadata: { schemas: ["APP", "REPORTING"] },
    operations: [...MOCK_CATALOG_OPERATIONS],
    type: "physical",
  },
  {
