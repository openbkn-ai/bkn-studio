...
export const subscriptionZhCN = {
  subscription: {
    ...
    plans: {
      ...
      community: {
        audience: "面向开发者、技术团队和生态伙伴,免费构建和验证业务知识网络,适合 Demo 和样板项目。",
        price: "免费",
        unit: "自部署 · 无限期",
      },
      enterprise: {
        audience: "面向以 OpenBKN 为企业 AI 平台底座的组织,在专业版基础上增加企业对象规则和业务溯源。",
        price: "洽谈",
        unit: "按合同授权",
      },
      inheritsFrom: "{{edition}}全部能力",
      professional: {
        audience: "面向准备做生产试点的团队,在社区版基础上增加自定义角色与权限、细粒度对象授权和高级数据连接。",
        price: "¥99,600",
        unit: "/ 年 · 标准价",
      },
      quota: {
