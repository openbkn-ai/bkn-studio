...
export const executionFactoryZhCN = {
  executionFactory: {
    ...
    capabilityCreateMenu: {
      ...
      addFunction: "添加 Function 能力",
      addFunctionDesc: "创建函数型工具集，并在沙箱中调试。",
      package: "能力包",
      importAdp: "导入 ADP 包（.adp）",
      importAdpDesc: "导入工具箱、MCP 或算子导出的能力包。",
    },
    ...
    quickApiParsedOk: "已识别服务地址和路径，请确认名称与工具集后保存。",
    quickApiIoPreviewTitle: "接口参数预览（保存前可核对入参、请求体与响应）",
    quickApiParsedParams: "已识别服务地址、路径和 {{count}} 个 Query 参数。",
