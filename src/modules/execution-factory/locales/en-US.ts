...
export const executionFactoryEnUS = {
  executionFactory: {
    ...
    quickApiRecognizeAction: "Recognize",
    ...
    quickApiParsedOk: "Detected service base URL and path. Confirm the name and toolset, then save.",
    quickApiIoPreviewTitle: "Endpoint preview (verify inputs, body, and responses before saving)",
    quickApiParsedParams: "Detected service base URL, path, and {{count}} query parameter(s).",
