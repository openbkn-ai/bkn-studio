  ...
  dataCatalog: {
    ...
    resourceWorkspace: {
      ...
      taskStatusUnavailable:
        "Index task status is temporarily unavailable. Resource details remain accessible; refresh the page to check the latest status.",
      indexStatusUnavailable: "Unable to confirm",
      permissionRefreshHint: "If your permissions have changed, refresh the page and try again.",
      loadErrorRefreshHint: "Please refresh the page and try again later.",
      discardChangesTitle: "Discard unsaved changes?",
      discardChangesDescription:
        "Switching tabs will discard the current unsaved changes and cannot be undone.",
      ...
      refreshMetadataConfirmDescription:
        "This creates a resource metadata discovery task. Field definitions, resource status, and index availability may change when it completes.",
      refreshMetadataConfirm: "Create discovery task",
      enableConfirmTitle: "Enable resource?",
      enableConfirmDescription:
        "Enabling restores preview, query, and index-build access for this resource.",
      disableConfirmTitle: "Disable resource?",
      disableConfirmDescription:
        "Disabling prevents preview, query, and index builds for this resource until it is enabled again.",
      ...
      semantic: {
        ...
        warnings: {
          sampleOmittedByPolicy:
            "The {{field}} field has the {{type}} type. Its sample values were omitted by the safety policy. When interpreting this field, the system relies only on metadata such as the field name, type, and existing descriptions; any resulting judgment may have lower confidence than one supported by sample values.",
          sampleOmittedByPolicyWithoutType:
            "The {{field}} field's sample values were omitted by the safety policy. When interpreting this field, the system relies only on metadata such as the field name, type, and existing descriptions; any resulting judgment may have lower confidence than one supported by sample values.",
          types: {
            binary: "binary",
            other: "other",
          },
        ...
        mock: {
          ...
          phoneInsufficientSamplesWarning:
            "The phone field has insufficient sample values, so no semantic suggestion was generated.",
    ...
    semanticWorkspace: {
      ...
      startConfirmWithSamplesDescription:
        "This creates a semantic understanding task and sends the selected sample rows for analysis.",
      empty: "No semantic-understanding tasks",
      confidenceThreshold: "Confidence threshold",
      includeSamples: "Include sample data",
      includeSamplesHint:
        "Sample data will be sent to the semantic-understanding service without masking.",
    ...
    resource: {
      ...
      sourceForeignKeyCount: "Source Foreign Keys",
      ...
      sourcePrimaryKeys: "Source Primary Keys",
      ...
      fieldType: "Type",
      fieldOriginalName: "Original Field Name",
      ...
      copyValueSuccess: "{{label}} copied",
      copyValueFailed: "Unable to copy {{label}}",
    ...
    build: {
      ...
      configReadOnly:
        "Index configuration is read-only. Manage resources permission is required to edit or save it.",
      ...
      executeFull: "Full",
      executeFullDescription:
        "Sync all rows from the source and rebuild the index. Use it for first builds or full refreshes.",
      executeIncremental: "Incremental",
      executeIncrementalDescription:
        "Continue from the build-key checkpoint and process only new or changed rows.",
      ...
      fieldFeatureConfigHint:
        "Configure keyword, full-text, and vector features for string and text fields.",
      roleKeyword: "Keyword feature",
      roleEmbedding: "Vector feature",
      primaryKeyFieldCount: "Primary key fields",
      incrementalFieldCount: "Incremental fields",
      keywordFieldCount: "Keyword fields",
      ...
      roleFulltext: "Full-text feature",
      excludedSchemaFieldsHint:
        "The build will exclude fields unsupported by the local index: {{fields}}.",
      excludedSchemaFieldsConfirmTitle: "Exclude fields and create the build task?",
      excludedSchemaFieldsConfirmContent:
        "The following binary or other fields will not be queried from the source or included in the local index: {{fields}}.",
      excludedSchemaFieldsConfirmOk: "Exclude and create",
      startBuildConfirmTitle: "Create build task?",
      startBuildConfirmContent:
        "This creates a build task and starts processing the resource data.",
      fieldCount: "{{count}} fields",
      fieldCount_one: "{{count}} field",
      fieldCount_other: "{{count}} fields",
      fulltextAnalyzer: "Analyzer",
      defaultKeywordIgnoreAbove: "Default keyword maximum indexed length",
      defaultKeywordIgnoreAboveHint:
        "Range: 1–8191. Used when a field has no override; longer values cannot be matched exactly through the keyword index.",
      defaultKeywordIgnoreAboveInvalid:
        "The default keyword maximum indexed length must be an integer from 1 to 8191.",
      ...
      keywordIgnoreAbove: "Maximum indexed length",
      keywordIgnoreAboveInvalid:
        "The keyword maximum indexed length must be an integer from 1 to 8191.",
      keywordRequiredHint:
        "String and text fields must retain a keyword feature for exact matching.",
      fulltextRequiredHint: "Text fields must retain a full-text feature.",
      inheritDefaultWithValue: "Use default ({{value}})",
      inheritDefaultMissing: "Use default (not configured)",
      ...
      fixedFeatureNameHint:
        "This feature uses the main field name or a fixed vector field name and cannot be renamed.",
      ...
      duplicateFeatureNames:
        "Feature names must be unique within a field. Rename duplicate features: {{features}}.",
      featureNameMustBeRelative:
        "Feature names must be relative and must not repeat the field name. Update: {{features}}.",
      ...
      analyzersLoadErrorFallback:
        "Refresh the page later; if it still fails, check the index service.",
      noAnalyzers: "No full-text analyzers are available; index configuration cannot be saved.",
      savedAnalyzerUnavailable:
        "Saved analyzer configuration is unavailable: {{analyzers}}. Choose an available analyzer to continue.",
      ...
      modelsLoadErrorFallback:
        "Refresh the page later; if it still fails, check the model management service.",
    ...
    task: {
      ...
      pauseResumeConfirmPauseContent:
        "This changes the task state and stops its current processing.",
