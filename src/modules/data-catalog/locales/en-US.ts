...
export const dataCatalogEnUS = {
  dataCatalog: {
    ...
    taskManagement: {
      ...
      columns: { task: "Task ID", catalog: "Catalog", strategy: "Discover Strategy", trigger: "Trigger", scope: "Task Scope", applyMode: "Apply Mode", confidence: "Confidence", applied: "Application Status" },
