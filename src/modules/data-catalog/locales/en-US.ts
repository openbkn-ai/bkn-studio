...
export const dataCatalogEnUS = {
  dataCatalog: {
    ...
    resourceWorkspace: {
      ...
      taskStatusUnavailable: "Index task status is temporarily unavailable. Resource details remain accessible; refresh the page to check the latest status.",
      ...
      refreshMetadataConfirmDescription: "This creates a resource metadata discovery task. Field definitions, resource status, and index availability may change when it completes.",
    ...
    resource: {
      ...
      editHint: "You can edit the resource description, field business names, and field descriptions here.",
    ...
    build: {
      ...
      fieldFeatureConfigHint: "Configure keyword, full-text, and vector features for string and text fields.",
      ...
      defaultKeywordIgnoreAboveHint: "Range: 1–8191. Used when a field has no override; longer values cannot be matched exactly through the keyword index.",
      defaultKeywordIgnoreAboveInvalid: "The default keyword maximum indexed length must be an integer from 1 to 8191.",
      ...
      keywordIgnoreAboveInvalid: "The keyword maximum indexed length must be an integer from 1 to 8191.",
      keywordRequiredHint: "String and text fields must retain a keyword feature for exact matching.",
      ...
      featureNameMustBeRelative: "Feature names must be relative and must not repeat the field name. Update: {{features}}.",
      ...
      analyzersLoadErrorFallback: "Refresh the page later; if it still fails, check the index service.",
      ...
      modelsLoadErrorFallback: "Refresh the page later; if it still fails, check the model management service.",
