...
export const dataCatalogZhCN = {
  dataCatalog: {
    ...
    indexWorkspace: {
      backToOverview: "返回概览",
      configureHint: "选择构建模式与字段角色，提交后开始索引构建",
    ...
    tree: {
      ...
      newConnection: "新建连接",
      addResource: "新建资源",
      physicalGroup: "物理 Catalog",
      logicalGroup: "逻辑 Catalog",
      logicalGroupHint: "系统内置",
      builtin: "内置",
      addLogical: "新增逻辑 Catalog",
      addLogicalTitle: "新增逻辑 Catalog",
      logicalName: "名称",
      logicalNamePlaceholder: "例如 team_analytics",
      logicalDescriptionPlaceholder: "可选，说明该逻辑分组用途",
      deleteLogicalTitle: "删除逻辑 Catalog",
      deleteLogicalDescription: '确认删除逻辑 Catalog「{{name}}」吗？其下资源将一并删除。',
      scanning: "扫描中",
      emptyPhysical: "暂无资源，可在数据连接中扫描发现",
      emptyLogical: "暂无资源",
      emptyPhysicalGroup: "暂无物理数据源连接",
      emptyLogicalGroup: "暂无逻辑 Catalog，可点击右上角新增",
      empty: "还没有数据连接",
      noMatch: "没有匹配的连接",
    ...
    catalog: {
      ...
      resourceSummary: "共 {{total}} 个资源，已建索引 {{indexed}} 个",
      goConnection: "连接",
      headerName: "名称",
      headerKind: "类型",
      headerConnector: "连接器",
    ...
    build: {
      ...
      roleFulltext: "全文检索",
      roleEmbeddingHint:
        "将被 Embedding 模型向量化，用于语义相似度检索；至少勾选一个文本字段。",
      ...
      embeddingRequired: "请至少选择一个向量嵌入字段。",
      fieldsRequired: "请至少选择一个向量嵌入字段或全文检索字段。",
      buildKeyRequired: "批量模式必须指定增量键字段。",
      model: "Embedding 模型",
