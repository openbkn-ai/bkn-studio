...
export const mockResources: CatalogResource[] = [
  ...
  makeResource({
    ...
    schema: [
      ...
      },
      {
        name: "content",
        displayName: "订单内容",
        description: "用于全文检索与向量检索的订单描述。",
        type: "text",
        originalName: "content",
        originalType: "text",
        originalDescription: "用于全文检索与向量检索的订单描述。",
        features: [
          { featureType: "fulltext", config: { analyzer: "ik_max_word" } },
          { featureType: "vector", config: { embedding_model: "sm-1" } },
        ],
  ...
  makeResource({
    id: "res-summary-only-orders",
    catalogId: "cat-009",
    name: "summary_only_orders",
    category: "table",
    schemaName: "public",
    sourceIdentifier: "public.summary_only_orders",
    description: "用于验收仅有目录摘要权限时，仍可导航到已授权 Resource。",
    sourceMetadata: {
      primaryKeys: ["order_id"],
    },
