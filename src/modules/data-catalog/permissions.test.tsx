...
function guardedRoutePaths(): string[] {
  return dataCatalogRoutes
    .filter((route) => isValidElement<RouteGuardProps>(route.element) && route.element.props.permissions)
...
describe("data-catalog permission points", () => {
   ...
   * have succeeded. This is exactly how the resource-verb convergence (bkn-foundry#986) would have
   * broken /index-builds had the guards been left alone.
   */
