...
import { DataConnectScanTaskDrawer } from "@/modules/data-connect/pages/DataConnectScanTaskDrawer";

import styles from "./DataConnectScanPage.module.css";
...
export function DataConnectScanPage() {
  ...
  useEffect(() => {
    const currentCatalogId = searchParams.get("catalogId") ?? undefined;
  ...
  }, [searchParams, selectedCatalogId, setSearchParams]);
