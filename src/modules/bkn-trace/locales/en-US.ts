...
export const bknTraceEnUS = {
  bknTrace: {
    ...
    settings: {
      archive: { action: "Archive now", description: "Verified archives automatically remove matching hot data; archive-only mode is not available.", fixedRule: "Archive managed logs and completed interactions older than 30 days", noHistory: "No archive jobs are available", title: "Historical data archive", unavailable: "The archive overview API is not available, so candidates cannot be determined and archiving is disabled." },
