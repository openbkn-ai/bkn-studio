...
export const bknTraceZhCN = {
  bknTrace: {
    ...
    settings: {
      archive: { action: "立即归档", candidates: "候选 {{count}} 条，截止 {{cutoff}}", completed: "归档已完成，热数据已清理。", confirm: "{{rule}} 归档校验成功后会自动清理对应热数据，且不能恢复。", confirmTitle: "确认执行归档", description: "归档校验成功后将自动清理对应热数据，不提供只归档不清理选项。", download: "下载", fixedRule: "归档超过 30 天的平台托管日志和已结束交互轮次", jobAction: "操作", jobCount: "归档条数", jobKind: "归档类别", jobRange: "实际归档范围", jobStatus: "状态", logRule: "固定归档超过 30 天的平台托管操作日志。", logTitle: "日志归档", noHistory: "尚无可展示的归档任务", retryCleanup: "继续清理", title: "历史数据归档", traceRule: "固定归档超过 7 天的技术 Trace 与已结束交互轮次完整包。", traceTitle: "Trace 归档", unavailable: "归档概览接口尚未提供，当前无法判断候选数据，归档操作不可用。" },
