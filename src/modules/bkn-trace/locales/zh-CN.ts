...
export const bknTraceZhCN = {
  bknTrace: {
    ...
    settings: {
      ...
      sourceState: { partial_management_audit_coverage: "已接入部分管理操作；其余操作尚未纳入审计。", source_health_check_failed: "来源健康探测失败，请检查服务连通性和接口响应。", source_not_configured: "未配置采集来源。", source_timeout: "来源探测超时。" },
