  ...
  bknTrace: {
    ...
    resultCount_other: "共 {{count}} 条可核对事实",
      ...
      detail: {
        ...
        method: "请求方法", operation: "操作摘要", operationStatus: "执行状态", operationType: "操作类型", rawFacts: "原始事实（默认收起）", recordedAt: "记录时间", requestId: "请求 ID", source: "来源", statusCode: "状态码", target: "操作对象", targetId: "对象 ID", taskId: "任务 ID",
