...
import { operationLabel, WILDCARD } from "@/modules/system-admin/utils/resource-catalog";
...
export function CatalogAuthorizeModal({
  ...
  const selectOperations = useCallback(
    (requested: string[]) => {
      ...
      setOps(
        catalogOps
          .filter((operation) => selected.has(operation.key))
