...
export const systemAdminZhCN = {
  systemAdmin: {
    ...
    objectCount_other: "可访问 {{count}} 个对象",
      ...
      createPageHint: "按向导完成：选择对象 → 选择权限主体（用户） → 勾选允许的操作。",
      ...
      drawerHint: "为该对象添加用户，并勾选允许的操作；取消全部操作即移除该权限主体。",
    ...
    proxyGovernance: {
      title: "知识网络代理治理",
      description: "查看当前账号有授权管理权限的知识网络代理状态。代理身份仅由后端托管，页面不会展示凭据或内部失败详情。",
      reconcile: "全量校准",
      reconcileConfirmTitle: "校准代理映射与授权账本？",
      reconcileConfirmContent: "系统将先校验你对所有相关知识网络的授权管理权限，再修复授权漂移；不修改知识网络模型或业务数据。",
      reconcileClean: "校准完成，未发现需要关注的问题。",
      reconcileIssues_one: "校准完成，发现 {{count}} 项需要关注的问题。",
      reconcileIssues_other: "校准完成，发现 {{count}} 项需要关注的问题。",
      reconcileSummary: "映射缺失 {{missing}} · 孤立映射 {{orphan}} · 账号冲突 {{conflicts}} · 授权漂移 {{drift}} · 处理失败 {{failed}}",
      reconcileDetails: {
        missing: "映射缺失",
        orphan: "孤立映射",
        conflicts: "账号冲突",
      ...
      searchPlaceholder: "搜索知识网络 ID 或代理账号 ID",
      empty: "当前授权范围内没有代理映射",
      retrySync: "重试同步",
      viewSources: "授权来源",
      sourcesTitle: "已发布授权来源",
      sourcesEmpty: "当前已发布模型没有代理授权来源",
      planModelVersion: "计划模型版本",
      publishedVersion: "已发布：{{version}}",
      filters: {
        all: "全部状态",
        ready: "已就绪",
        pending: "同步中",
      ...
      toast: {
        syncSucceeded: "代理权限同步完成",
        reconcileCompleted: "代理校准完成",
      },
    },
    audit: {
      title: "审计日志",
