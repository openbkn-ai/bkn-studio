...
export const systemAdminEnUS = {
  systemAdmin: {
    ...
    objectCount_other: "{{count}} objects",
      ...
      calloutSuffix:
        "). This list renders only server-provided effective decisions; roles, inheritance, bundles, explicit denies and prerequisites are never merged in the browser. Open details to revoke a specific source record.",
      permissionHelp: "Permission guide",
