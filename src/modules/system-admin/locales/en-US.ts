...
export const systemAdminEnUS = {
  systemAdmin: {
    ...
    objectCount_other: "{{count}} objects",
      ...
      createPageHint: "Complete the steps: pick an object, pick subjects (users), then choose allowed operations.",
    ...
    proxyGovernance: {
      title: "Knowledge Network Proxy Governance",
      description: "Inspect managed proxies for knowledge networks in your authorization scope. Proxy credentials and internal failure details are never exposed here.",
      reconcile: "Reconcile all",
      reconcileConfirmTitle: "Reconcile proxy mappings and the authorization ledger?",
      reconcileConfirmContent: "The service checks your authorize operation on every affected network before repairing drift. Knowledge-network models and business data are not changed.",
      reconcileClean: "Reconciliation completed with no issues requiring attention.",
      reconcileIssues_one: "Reconciliation completed with {{count}} issue requiring attention.",
      reconcileIssues_other: "Reconciliation completed with {{count}} issues requiring attention.",
      reconcileSummary: "Missing {{missing}} · orphaned {{orphan}} · conflicts {{conflicts}} · authorization drift {{drift}} · failed {{failed}}",
      reconcileDetails: {
        missing: "Missing mappings",
        orphan: "Orphan mappings",
        conflicts: "Account conflicts",
        drift: "Authorization drift",
        failed: "Failed",
      },
      searchPlaceholder: "Search network ID or proxy account ID",
      empty: "No proxy mappings are visible in your authorization scope",
      retrySync: "Retry sync",
      viewSources: "Grant sources",
      sourcesTitle: "Published grant sources",
      sourcesEmpty: "The published model has no proxy grant sources",
      planModelVersion: "Plan model version",
      ...
      errorCodes: {
        PROXY_SYNC_FAILED: "Latest synchronization failed",
      },
      columns: {
        network: "Knowledge network ID",
        proxyAccount: "Managed proxy account",
        lifecycle: "Lifecycle",
        sync: "Sync status",
      ...
      toast: {
        syncSucceeded: "Proxy permission synchronization completed",
        reconcileCompleted: "Proxy reconciliation completed",
      },
    },
    audit: {
      title: "Audit Log",
