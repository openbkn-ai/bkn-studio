export const systemAdminEnUS = {
  systemAdmin: {
    ...
    objectGrants: {
      ...
      calloutSuffix: "): roles come first; this grants access to a single object directly to a user. Effective access = role permissions ∪ object grants. For whole-type / all access, use role management.",
      pickObjectFirst: "Pick an object first",
      pickGranteeFirst: "Pick a user or department first",
      pickerNext: "Next · Configure",
      pickerHint: "A grant targets one object and grants its access to a user.",
      pickerPlaceholder: "Pick an object to authorize…",
      drawerTitle: "Authorize · {{name}}",
      drawerHint: "Add a user to this object and pick the allowed operations; clearing all operations removes the user.",
