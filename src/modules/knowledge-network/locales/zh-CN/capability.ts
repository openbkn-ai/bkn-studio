...
export const capabilityPart = {
  ...
  capabilityPickerBoxToolCountEnabled: "共 {{count}} 个工具，已启用 {{enabled}} 个",
  capabilityPickerBoxToolCountEnabled_one: "共 {{count}} 个工具，已启用 {{enabled}} 个",
  capabilityPickerBoxToolCountEnabled_other: "共 {{count}} 个工具，已启用 {{enabled}} 个",
  capabilityPickerWholeBoxHint:
    "整集挂载在写入时展开为该工具集当前已启用的工具；未启用的工具不会挂载，集内后续新增的工具也不会自动挂载。",
  capabilityPickerWholeServerHint:
    "整体挂载在写入时展开为该 MCP Server 当前提供的全部工具；之后新增的工具不会自动挂载。",
  capabilityPickerReasonBoxUnpublished: "未发布",
  capabilityPickerReasonToolDisabled: "未启用",
  capabilityPickerReasonNoEnabledTools: "无已启用工具",
  capabilityPickerReasonNoTools: "无工具",
  capabilityPickerReasonNotFound: "已不存在",
  capabilityPickerReasonLoadFailed: "读取失败",
  capabilityPickerDeselected: "以下所选项当前无法挂载，已取消勾选",
