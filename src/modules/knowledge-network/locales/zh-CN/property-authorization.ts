...
export const propertyAuthorizationPart = {
  ...
  propertyAuthorizationSubjectDescription: "选择要配置的用户或角色。",
  propertyAuthorizationSubjectHelp:
    "仅支持按用户或角色配置。组织仅用于筛选用户列表，不作为授权主体。",
  propertyAuthorizationSelectUser: "选择要配置属性访问控制的用户",
  propertyAuthorizationUserOrganizationFilter: "按组织筛选用户",
  ...
  rowFilterSourcesTitle: "生效策略",
  rowFilterNoRuleSources: "未配置行过滤规则。",
  rowFilterSourceCurrentUser: "用户：{{name}}",
  rowFilterSourceCurrentRole: "角色：{{name}}",
  rowFilterSourceRole: "角色：{{name}}",
  rowFilterFixedConditionsLabel: "固定条件：",
