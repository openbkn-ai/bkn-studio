...
export const networkPart = {
  ...
  permissionRequestTitle: "申请知识网络权限",
  permissionRequestResourceTitle: "申请资源权限",
  permissionRequestNetwork: "知识网络",
  permissionRequestResource: "资源",
  permissionRequestOperations: "申请权限",
  permissionRequestReason: "申请原因",
