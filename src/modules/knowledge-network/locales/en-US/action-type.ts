...
export const actiontypePart = {
  ...
  actionTypeResourceMappingStep: "Execution unit",
  ...
  actionTypeExecutionTool: "Execution unit",
  ...
  actionTypeDeleteDescription: 'Delete "{{name}}"? This action cannot be undone.',
  ...
  actionTypeExecutionParameterSource: "Parameter position",
  actionTypeExecutionParameterValue: "Value",
  actionTypeExecutionParameterValueSource: "Value source",
  ...
  actionTypeOperatorLabel: "Execution unit",
  actionTypeOperatorSelectPlaceholder: "Select tool name",
  actionTypeExecutionParameterNamePlaceholder: "Enter a parameter name",
  actionTypeExecutionParameterRequired: "Configure at least one valid execution parameter mapping.",
  ...
  actionTypeExecutionToolRequired: "Please select an execution unit.",
  ...
  actionTypeExecutionConfigSubtitle: "Maintain the action execution source and parameter mappings.",
  ...
  actionTypesDescription: "Review and maintain action types under the active knowledge network.",
  ...
  actionTypeOpenapiToolSearchPlaceholder: "Search API toolset / API tool name",
  actionTypeFunctionToolSearchPlaceholder: "Search function set / function name",
