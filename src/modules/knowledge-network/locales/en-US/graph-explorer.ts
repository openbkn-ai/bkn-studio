    ...
    ai: {
      ...
      prompt: {
        ...
        rules: [
          ...
          "run_cypher accepts one `MATCH ... [WHERE ...]` only: one continuous path, labels are object type ids, every relation is directed and names exactly one relation type id, no variable length, no RETURN.",
