...
export const objecttypePart = {
  ...
  objectTypeDescriptionFillSuccess_other: "Filled descriptions for {{count}} properties",
  ...
  objectTypeCreateDescription:
    "Create an object type and its properties through a multi-step form.",
  ...
  objectTypeDeleteDescription: 'Delete "{{name}}"? This action cannot be undone.',
  ...
  objectTypeLogicAttributeDeleteConfirmMultiple: "Delete the selected {{count}} logic properties?",
  ...
  objectTypeLogicAttributeNameExists: 'Property name "{{name}}" already exists in data properties.',
  ...
  objectTypeLogicResultPathHint:
    "Optional JSONPath. The full tool response is returned when empty.",
  ...
  objectTypeIndexStateUnknown: "Index status pending confirmation",
  objectTypeIndexStateResourceMissing: "Bound resource does not exist",
  objectTypeIndexStateNotApplicable: "Not applicable",
  objectTypeIndexFeatureAvailable: "Available",
  objectTypeIndexFeatureUnavailable: "Configured, index unavailable",
  objectTypeIndexFeatureUnknown: "Configured, status pending confirmation",
  ...
  objectTypePropertyIndexFeatures: "Data features",
  ...
  objectTypesDescription: "Review and maintain object types under the active knowledge network.",
  ...
  objectTypeToolbarHint: "This slice covers list, create, edit, and delete for object types first.",
