...
export const contextLoaderPanelPart = {
  contextLoaderPanel: {
    ...
    toolNames: {
      ...
      bkn_context: "Write Managed Context",
    ...
    common: {
      ...
      mcpLoaded: "{{count}} services loaded",
      mcpLoaded_one: "{{count}} service loaded",
      mcpLoaded_other: "{{count}} services loaded",
      restAvailable: "{{count}} available",
    ...
    toolDiscovery: {
      ...
      onlineCount_one: "{{count}} tool online",
      onlineCount_other: "{{count}} tools online",
    ...
    request: {
      ...
      queryCollapsed_one: "Collapsed. Expand to edit {{count}} parameter",
    ...
    schema: {
      ...
      overview: "Overview",
      overviewExpand: "Show full description",
      overviewCollapse: "Collapse description",
      businessExample: "Business request example",
      copiedExample: "Business request example copied",
      invalidExample: "The current request body is not valid JSON, so no example can be shown.",
      ...
      noFields: "No structured fields were declared for this schema.",
