...
export const capabilityPart = {
  ...
  capabilityMountFunction: "Mount function",
  capabilityMountSkill: "Mount SKILL",
  ...
  capabilityEmptyFunctions:
    "No function mounted yet. Use Mount function to pick from the execution factory.",
  ...
  capabilityPickerEmptyFunctions: "No tool available to mount.",
