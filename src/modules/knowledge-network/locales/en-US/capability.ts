...
export const capabilityPart = {
  ...
  capabilityColumnMountKind: "Mounted",
  capabilityColumnReferences: "Referenced by",
  capabilitySourceNotMounted: "Not mounted",
  ...
  capabilityNoVisibleFunctions: "No function is available to view.",
  ...
  capabilityPickerBoxToolCountEnabled: "{{count}} tools, {{enabled}} enabled",
  capabilityPickerBoxToolCountEnabled_one: "{{count}} tool, {{enabled}} enabled",
  capabilityPickerBoxToolCountEnabled_other: "{{count}} tools, {{enabled}} enabled",
  capabilityPickerWholeBoxHint:
    "A whole-toolset mount is expanded at write time into the tools the toolset has enabled now. Disabled tools are skipped, and tools added later are not inherited.",
  capabilityPickerWholeServerHint:
    "A whole-Server mount is expanded at write time into every tool the MCP Server exposes now. Tools added later are not inherited.",
  capabilityPickerReasonBoxUnpublished: "Not published",
  capabilityPickerReasonToolDisabled: "Disabled",
  capabilityPickerReasonNoEnabledTools: "No enabled tools",
  capabilityPickerReasonNoTools: "No tools",
  capabilityPickerReasonNotFound: "No longer exists",
  capabilityPickerReasonLoadFailed: "Failed to load",
  capabilityPickerDeselected: "These picks cannot be mounted right now and were unticked",
  capabilityPickerDeselectedItem: "{{name}}: {{reason}}",
