...
export const networkPart = {
    ...
    experienceRestTitle: "REST integration",
    ...
    experienceRestDescription: "Connect to knowledge network capabilities through REST, configure requests, and inspect live responses.",
    ...
    workspaceExperienceRest: "REST integration",
