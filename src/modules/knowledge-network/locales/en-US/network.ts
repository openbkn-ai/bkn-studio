...
export const networkPart = {
    ...
    authorizeAdd: "Add",
    authorizeAddTitle: "Add access",
    authorizeCurrent: "Current access",
    authorizeEditTitle: "Edit access",
    authorizeEmpty: "Nobody but you has access yet.",
    authorizeOp: {
      authorize: "Share",
      create: "Create",
      delete: "Delete",
    ...
    authorizePickOperation: "Select at least one operation.",
    authorizePickUser: "Select who to share with.",
    authorizeRemoveConfirm: "Remove this user's access to the knowledge network entirely?",
    authorizeRemoved: "Access removed",
    authorizeReplaceHint:
      "Submitting replaces this user's access with exactly the operations checked above; anything unchecked is taken away. Sharing itself can only be granted by an administrator.",
    authorizeSaved: "Access saved",
    authorizeTitle: "Share · {{name}}",
    authorizeUserPlaceholder: "Search by account or name",
    export: "Export",
