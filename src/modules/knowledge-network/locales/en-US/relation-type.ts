...
export const relationtypePart = {
  ...
  relationTypeResourceMappingOption: "Connect object type properties through a resource",
  relationTypeResourceMappingRequired: "Configure at least one complete resource mapping.",
  ...
  relationTypeDeleteDescription: 'Delete "{{name}}"? This action cannot be undone.',
  ...
  relationTypeMappingSubtitle: "Maintain source/target object types and property mapping rules.",
  ...
  relationTypePropertyMappingRequired: "Configure at least one valid property mapping.",
