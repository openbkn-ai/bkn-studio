...
export const shellEnUS = {
  shell: {
    ...
    items: {
      ...
      executionUnitManagement: "Capability Management",
      allExecutionUnits: "Capability Market",
      executionFactorySandboxRuntime: "Sandbox Runtime",
      executionUnitManagementTooltip: "Manage toolsets, MCP services, skills, and operator capabilities in your domain",
      allExecutionUnitsTooltip: "Browse the capability market and introduce reusable resources into your domain",
