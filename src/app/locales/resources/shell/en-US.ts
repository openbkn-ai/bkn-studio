...
export const shellEnUS = {
  shell: {
    ...
    items: {
      ...
      executionUnitManagementTooltip: "Manage operators, toolboxes, MCP servers, and skills in your tenant",
      allExecutionUnitsTooltip: "Browse the market catalog and introduce resources into your tenant",
